...
/**
 * This class represents a single lane of approach/egress to/from a given intersection, per FHWA GID message specification.  It
 * models the lane's geometry as a series of nodes extending away from the intersection's reference point (center point),
 * with the first node in the list being the stop bar, and the last node being farthest away from the intersection.
 * The intersection also has other attributes to describe it.
 * 
 * @author starkj
 *
 */
public class Lane implements OutputData {
	 ...
	 * 
	 * @param ref is the intersection's reference point
	...
	/**
	 * always : stores whether or not this lane is approaching the intersection (if not, then it is an egress lane)
	 */
	...
	/**
	 * always : indicates whether or not this lane is approaching the intersection (if not, then it is an egress lane)
	 */
